...
const Terminal_SVG: React.FC<Props> = (props: Props) => {
  ...
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24" fill={primaryColor}>
      <path d="M5.0333 14.8284L6.44751 16.2426L10.6902 12L6.44751 7.75733L5.0333 9.17155L7.86172 12L5.0333 14.8284Z" fill={secondaryColor} />
      <path d="M15 14H11V16H15V14Z" fill={secondaryColor} />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
