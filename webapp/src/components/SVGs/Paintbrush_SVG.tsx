...
const Paintbrush_SVG: React.FC<Props> = (props: Props) => {
  ...
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" fill={"none"} width={width} height={height} viewBox="0 0 24 24">
      <rect x="7.54" y="5.07" width="13.81" height="8.98" transform="translate(10.99 -7.41) rotate(45)" stroke={primaryColor} strokeMiterlimit={10} strokeWidth={2} />
      <path
